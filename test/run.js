...
var walk_dir = function(dir, validation_function, cb) {
        ...
        list.forEach(function(file) {
            ...
            fs.stat(file, function(err, stat) {
                if (stat && stat.isDirectory()) {
                    methods.walk_dir(file, validation_function, function(err, res) {
...
module.exports = {
    run_tests: function(cb) {
        //run(function(err) {
        var files = ['./test/foo.unit.js'];
        files.forEach(function(file) {
            mocha.addFile(file);
        });
